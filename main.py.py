...
def initialize_edges_links(df_edges,all_nodes, layer ,group_nodes, hash_dict, id_source = None, id_destination = None, source = None, destination = None, barabasi = False):     
    '''
...
if __name__ == '__main__':
    ...
    layers ='werkschool','buren', 'household', 'familie'
    barabasi = 1
    percentage = 1
    ...
    for layer_number, layer in enumerate(layers):
        ...
        source, destination, source_id, destination_id = initialize_edges_links(df_edges, all_nodes, layer ,group_nodes, hash_dict, id_source = None, id_destination = None, source = None, destination = None, barabasi = barabasi ,percentage = percentage)
